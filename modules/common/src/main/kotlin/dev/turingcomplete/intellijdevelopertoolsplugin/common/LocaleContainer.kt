...
/**
 * A wrapper class for a [java.util.Locale]. This is required because the search function
 * of the `comboBox` in the UI DSL does work on the human-readable the display
 * name. It will use the `toString()` (e.g., `de_DE`) representation of the [java.util.Locale]
 * instead.
 */
