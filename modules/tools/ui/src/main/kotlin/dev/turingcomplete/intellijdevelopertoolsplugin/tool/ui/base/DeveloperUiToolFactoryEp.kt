...
class DeveloperUiToolFactoryEp<T : DeveloperUiToolFactory<*>> :
  CustomLoadingExtensionPointBean<T>() {
  // -- Properties ---------------------------------------------------------- //

  @Attribute("id") @RequiredElement lateinit var id: String

  @Attribute("implementationClass") @RequiredElement lateinit var implementationClass: String

  @Attribute("preferredSelected") var preferredSelected: Boolean = false

  @Attribute("groupId") var groupId: String? = null

  @Attribute("internalTool") var internalTool: Boolean = false
