...
import dev.turingcomplete.intellijdevelopertoolsplugin._internal.tool.editor.EscapersUnescapers.Escaper
import dev.turingcomplete.intellijdevelopertoolsplugin._internal.tool.editor.EscapersUnescapers.Unescaper
import dev.turingcomplete.intellijdevelopertoolsplugin._internal.tool.editor.EscapersUnescapers.commonEscaper
import dev.turingcomplete.intellijdevelopertoolsplugin._internal.tool.editor.EscapersUnescapers.commonUnescaper
import dev.turingcomplete.intellijdevelopertoolsplugin._internal.tool.editor.EscapersUnescapers.executeEscapeInEditor
import dev.turingcomplete.intellijdevelopertoolsplugin._internal.tool.editor.EscapersUnescapers.executeUnescapeInEditor

internal abstract class EscapeUnescapeIntentionAction : IntentionAction, LowPriorityAction {
  // -- Properties -------------------------------------------------------------------------------------------------- //
  // -- Initialization ---------------------------------------------------------------------------------------------- //
  // -- Exported Methods -------------------------------------------------------------------------------------------- //
