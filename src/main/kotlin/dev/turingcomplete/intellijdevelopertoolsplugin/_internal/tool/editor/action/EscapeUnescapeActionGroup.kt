...
import dev.turingcomplete.intellijdevelopertoolsplugin._internal.tool.editor.EscapersUnescapers
...
internal open class EscapeUnescapeActionGroup : DefaultActionGroup("Escape/Unescape", false) {
  // -- Properties -------------------------------------------------------------------------------------------------- //
