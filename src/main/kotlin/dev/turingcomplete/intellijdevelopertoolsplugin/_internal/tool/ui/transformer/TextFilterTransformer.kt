...
class TextFilterTransformer(
  ...
  private val filteringContainingModeText = configuration.register("filteringContainingModeText", "", INPUT, EXAMPLE_FILTERING_CONTAINING_MODE_TEXT)
  private val filteringNotContainingModeText = configuration.register("filteringNotContainingModeText", "", INPUT, EXAMPLE_FILTERING_NOT_CONTAINING_MODE_TEXT)
  private val filteringRegexModeText = configuration.register("filteringRegexModeText", "", INPUT, EXAMPLE_FILTERING_REGEX_MODE_TEXT)
  ...
  override fun Panel.buildMiddleConfigurationUi() {
    ...
    buttonsGroup {
      row {
        cell()
        val containingFilteringModeRadioButton = radioButton("Containing:")
      ...
      row {
        cell()
        val containingFilteringModeRadioButton = radioButton("Not containing:")
  ...
  override fun transform() {
    val tokenFilter: (String) -> Boolean = when (filteringMode.get()) {
      ...
      FilteringMode.REGEX -> {
        val filteringRegexModeTextValue = try {
