...
import dev.turingcomplete.intellijdevelopertoolsplugins._internal.ui.instance.dialog.OpenMainDialogAction
...
class AddOpenMainDialogActionToMainToolbarTask(
  ...
  companion object {
     ...
     * but it will be hidden (this due to the internal working toolbar
