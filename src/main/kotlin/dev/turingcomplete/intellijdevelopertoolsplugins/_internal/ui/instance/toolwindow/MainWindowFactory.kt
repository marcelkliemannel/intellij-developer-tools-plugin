package dev.turingcomplete.intellijdevelopertoolsplugins._internal.ui.instance.toolwindow
...
import dev.turingcomplete.intellijdevelopertoolsplugins._internal.settings.DeveloperToolsToolWindowSettings
...
class MainWindowFactory : ToolWindowFactory, DumbAware {
  ...
  private class ToolWindowDeveloperToolContentPanel(
    ...
    override fun Row.buildTitle() {
      ...
      val toggleMenuAction: AbstractAction = object : AbstractAction(developerToolNode.developerToolPresentation.contentTitle) {
